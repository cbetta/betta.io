...
<div class="ui embed" data-source='youtube' data-id="JHtMN8TxUfc" data-placeholder="<%= image_path '/images/slides/sins/sins.001.jpeg' %>
"></div>
...
<div class="ui embed" data-source='youtube' data-id="SyCj5ce2jYk" data-placeholder="<%= image_path '/images/slides/sins/sins.003.jpeg' %>
"></div>
...
<%= slide_image 'sins', 160 %>

### Prevent Cognitive Overload

<%= slide_image 'sins', 161 %>

### Only Ask Questions When Needed

<%= slide_image 'sins', 163 %>

### Present Information with Structure

<%= slide_image 'sins', 164 %>

### Present Information on Time

<%= slide_image 'sins', 165 %>

### Tell The Best Stories

<%= slide_image 'sins', 166 %>

### Tell The Whole Story

<%= slide_image 'sins', 167 %>
